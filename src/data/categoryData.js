...
const categoryDate = [
  ...
  { name: "연애", color:"red", code: "date", img: date, message: <div>메세지</div> },
  { name: "유머", color:"blue", code: "humor", img: humor, message: <div>메세지</div> },
  { name: "헬프", color:"orange", code: "help", img: help, message: <div>메세지</div> },
  { name: "망상", color:"yellow", code: "delusion", img: delusion, message: <div>메세지</div> },
  { name: "정치", color:"aqua", code: "politics", img: politics, message: <div>메세지</div> },
  { name: "기타", color:"black", code: "etc", img: etc, message: <div>메세지</div> },
];
